...
public class Quetion_Model_List {
    ...
    private String quetion_id,question,qpart1, qpart2, qpart3, qpart4, qpart5, op1,op2,op3,op4,answer,question_image,question_image1,question_image2, question_image3, question_image4, op1_image,op2_image,op3_image,op4_image, questionno;

    public Quetion_Model_List(String quetion_id, String question, String qpart1, String qpart2, String qpart3, String qpart4, String qpart5, String op1 ,String op2,String op3,String op4,
                              String answer,String question_image, String question_image1, String question_image2, String question_image3, String question_image4, String op1_image,String op2_image,String op3_image,String op4_image, String questionno) {
